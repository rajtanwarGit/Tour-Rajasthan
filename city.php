...
<body method="get" onload="testCity()" onunload="deleteAllCookies()">
    ...
    <nav class="navigation max-width-1 m-auto">
        <div class="nav-left">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item"><a href="" class="nav-link active">Place - <span id="text"></span></a></li>
            </ul>
        </div>
        <div class="nav-right">
    ...
    <!-- Content -->
    <div class="content-img" style="background-image: linear-gradient(0deg, rgba(37, 36, 36, 0.4), rgba(59, 51, 51, 0.2)), url('<?php echo $city_img; ?>');">
        <h1><?php echo $city_name; ?></h1>
        <h3><?php echo $city_quote; ?></h3>
    </div>

    <div class="desc">
        <h2><?php echo $desc_p1; ?></h2> <br>

        <h2><?php echo $desc_p2; ?> </h2> <br>

        <h2><?php echo $desc_p3; ?></h2>
    </div>
    ...
    <div class="attractions">
        <div class="att-content">
            ...
            <h2><i class="fas fa-map-marker"></i> ATTRACTIONS & PLACES TO VISIT AND EXPLORE IN CITY</h2>
            <h3>Come explore the wonders and sites that <?php echo $city_name; ?> has to offer. There’s always something to see in Rajasthan.
            </h3>
            <ul>
                <li><?php echo $att1; ?></li>
                <li><?php echo $att2; ?></li>
    ...
    <div class="reach">
        <div class="left">
            ...
            <ul>
                <li><i class="fas fa-plane"></i> <?php echo $plane; ?> </li>
                <li><i class="fas fa-car"></i> <?php echo $road; ?></li>
                <li><i class="fas fa-train"></i> <?php echo $train; ?></li>
            </ul>
        </div>
        <div class="city-marker-img" style="background-image: url('<?php echo $marker_img; ?>');"> </div>
    </div>
